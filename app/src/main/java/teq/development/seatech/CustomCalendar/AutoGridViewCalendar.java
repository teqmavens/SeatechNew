...
public class AutoGridViewCalendar extends GridView {

    private static final String TAG = "AutoGridViewCalendar";
    private int numColumnsID;
    private int previousFirstVisible;
    private int numColumns = 1;

    public AutoGridViewCalendar(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(attrs);
    }

    public AutoGridViewCalendar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public AutoGridViewCalendar(Context context) {
        super(context);
    }
