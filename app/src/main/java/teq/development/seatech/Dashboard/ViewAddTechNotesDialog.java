...
import teq.development.seatech.JobDetail.VMJobDetail;
...
public class ViewAddTechNotesDialog extends DialogFragment implements View.OnClickListener {
    ...
    static ViewAddTechNotesDialog newInstance(int num, String jobid) {
        ViewAddTechNotesDialog f = new ViewAddTechNotesDialog();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.cross:
                ...
                break;
            case R.id.submit:
                SubmitAddDashboard(HandyObject.getPrams(getActivity(), AppConstants.LOGINTEQ_ID), comingJobId, et_addtechnotes.getText().toString(), "Dashboard");
                break;
        }
    }
                            ...
                            try {
                                ...
                                if (jsonObject.getString("status").toLowerCase().equals("success")) {
                                    ...
                                    for (int i = 0; i < jsonArray.length(); i++) {
                                        ...
                                        JSONArray jArray_OffTheRecord = jobjInside.getJSONArray("Dashboard");
                                        ...
                                        cv.put(ParseOpenHelper.JOBSTECHDASHBOARDNOTES, OffTheRecord);
                                        cv_current.put(ParseOpenHelper.JOBSTECHDASHBOARDNOTESCURRDAY, OffTheRecord);
