...
import teq.development.seatech.databinding.FrgmJobdetailstaticscheduleBinding;

public class JobDetailStaticSchedule extends Fragment {

    public FrgmJobdetailstaticscheduleBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.frgm_jobdetailstaticschedule, container, false);
        binding = DataBindingUtil.bind(rootView);
        binding.setFrgmjobdetailstaticschedule(this);
        ...
        protected void onPostExecute(ArrayList<UrgentMsgSkeleton> urgentMsgSkeletons) {
            ...
            if (urgentMsgSkeletons.size() == 0) {
              ...
              /*  if (updateUrgent == true) {
                ...
                AdapterDashbrdUrgentMsg adapterurgentmsg = new AdapterDashbrdUrgentMsg(context, urgentMsgSkeletons, JobDetailStaticSchedule.this);
