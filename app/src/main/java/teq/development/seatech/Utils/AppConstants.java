...
public class AppConstants {
    ...
    public static final String LOGINTEQ_DOB = "loginteq_dob";
    public static final String LOGINTEQ_PHONE = "loginteq_phone";
    public static final String LOGINTEQ_ROLE = "loginteq_role";
    ...
    public static final String ISALLMSG_ACKNOWLEDGE = "isallmsg_acknowledge";
    public static final String LCJOBCOMPLETION_COUNT = "lcjobcompletion_count";
    public static final String NEEDPART_COUNT = "needpart_count";
