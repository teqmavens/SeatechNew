...
public class UserPicture {
    ...
    public Bitmap getBitmap() throws IOException {
        ...
        //640,800
        //last change 350,400
        return ScalingUtilities.createScaledBitmap(picture, 680, 900, ScalingUtilities.ScalingLogic.FIT);
    }
    public Bitmap getBitmapstart() throws IOException {
        if (!getInformation())
            throw new FileNotFoundException();
        if (!getStoredDimensions())
            throw new InvalidObjectException(null);
        ...
        //640,800
        //last change 350,400
        return ScalingUtilities.createScaledBitmap(picture, 400, 400, ScalingUtilities.ScalingLogic.CROP);
    }
}
