...
import com.vadevelopment.RedAppetite.newssection.NewsFragment;
...
public class Map_SearchDetailFragment extends android.app.Fragment implements View.OnClickListener, ClusterManager.OnClusterItemClickListener<MyItem> {
    ...
    private void setToolbar(View view, Bundle bundle) {
        ...
        mdashboard.setting.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (getArguments() != null && getArguments().getString(Consts.ONDETAIL_FROM).equalsIgnoreCase("search")) {
                  /*  SearchFirstFragment sf_frgm = new SearchFirstFragment();
                    Bundle bundle = new Bundle();
                    bundle.putString(Consts.FROMSEARCH_MAPDETAIL, "mapdetail");
                    sf_frgm.setArguments(bundle);*/
                    mdashboard.displayWithoutViewFragmentWithoutv4backstack(new SearchFirstFragment());
                } else {
                    mdashboard.displayWithoutViewFragmentWithoutv4backstack(new NewsFragment());
                }
            }
        });
    ...
    public void onResume() {
        ...
        mapView.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap mMap) {
                ...
                mClusterManager.setOnClusterItemClickListener(com.vadevelopment.RedAppetite.searchsection.Map_SearchDetailFragment.this);
