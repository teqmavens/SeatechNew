...
public class SearchDetail_Fragment extends android.app.Fragment implements View.OnClickListener {

    private static String TAG = "SearchDetail_Fragment";
    ...
    String make_sharetext, fullimage_url;
    TextView dynamic_number, fix_number;
    private TextView text_editreview, text_addtofvrt, seemore, moveto_prev, allnews, moveto_next, buildingname, ratingstars,
    ...
    ArrayList<Skeleton_SearchFirst> arraylist_custom;
    ArrayList<NewsSkeletonInside> arraylist_news;
    CustomPagerAdapter mCustomPagerAdapter;
    Dialog openDialog;
    private SQLiteDatabase database;
    private SharedPreferences preferences;
    private String which_latlong, lid;
    ...
    private RelativeLayout rl_days, rl_description, rl_specialoffr, rl_openingtimes, rl_video;
    private String phone_no, building_address, isReviewed, isfav, image_url, uf1, latitude, longitude, categorytype, video_url;
    ...
    private void initViews(View view) {
        ...
        if (getArguments() != null) {
            lid = getArguments().getString(Consts.SEARCH_CLICKLID);
        ...
        playvideo_btn.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mdashboard.mapicon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (arraylist_custom.size() > 0) {
                    Map_SearchDetailFragment map_sdetail = new Map_SearchDetailFragment();
                    Bundle bundle = new Bundle();
                    bundle.putParcelableArrayList(Consts.DETAIL_ARRAYLIST, arraylist_custom);
                    if (getArguments().getString(Consts.CHECKCLICK_FROM).equalsIgnoreCase("search")) {
                        bundle.putString(Consts.ONDETAIL_FROM, "search");
                    } else {
                        bundle.putString(Consts.ONDETAIL_FROM, "event");
                    }
                    map_sdetail.setArguments(bundle);
                    mdashboard.flipViewFragmentWithanim(map_sdetail);
                }

                // mdashboard.displayWithoutViewFragmentWithoutBackstack(new Map_SearchDetailFragment());
            }
        });
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.seemore:
                ...
                // mdashboard.displayWithoutViewFragment(new NewsSeemore_Fragment());
                break;
            case R.id.allnews:
                //  mdashboard.displayWithoutViewFragment(new NewsDetail_Fragment());
                break;
            ...
            case R.id.image_reporterror:
                //    mdashboard.displayWithoutViewFragmentWithanim(new ReportError_Fragment());
        ...
        rl_email.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    if (getArguments().getString(Consts.CHECKCLICK_FROM).equalsIgnoreCase("search")) {
                        intent.putExtra(Intent.EXTRA_SUBJECT, getString(R.string.redappetite_place));
                    } else {
    ...
    private void publishText() {
        ShareLinkContent linkContent = new ShareLinkContent.Builder().setContentTitle("RedApppTitle").setContentDescription("Reddddddddddddddddddddddddddddddddddddddd").setContentUrl(Uri.parse("http://developers.facebook.com/android"))
                .build();
        ShareApi.share(linkContent, new FacebookCallback<Sharer.Result>() {
            @Override
            public void onSuccess(Sharer.Result result) {
                HandyObjects.showAlert(getActivity(), "Success");
            }

            @Override
            public void onCancel() {
                HandyObjects.showAlert(getActivity(), "Cancel");
            }
        ...
        StringRequest jsonObjReq = new StringRequest(Request.Method.POST,
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (jboj.getString("message").equalsIgnoreCase("Success")) {
                        ...
                        //allreview_ratingbar.setRating(Float.parseFloat(jobj_alllist.getString("avgRate")));
                        ...
                        if (jobj_alllist.getString("address").contains(",")) {
                           ...
                           /* for (int i = 0; i < addr_string.length; i++) {
                                address_builder.append(addr_string[i] + "\n");
                                if (address_builder.toString().endsWith("\n")) {
                                    address_builder.toString().substring(0, address_builder.toString().length() - 1);
                                }
                            }*/
                            // address_builder.append(jobj_alllist.getString("country"));
                            //  address_valuetext.setText(address_builder.toString()+"\n"+jobj_alllist.getString("country"));
                        } else {
            ...
            protected Map<String, String> getParams() {
                ...
                if (which_latlong.equalsIgnoreCase("current")) {
                    ...
                    HandyObjects.showAlert(getActivity(), which_latlong.split(",")[1]);
        ...
        if (cursor != null) {
            if (cursor.getCount() > 0) {
                ...
                while (!cursor.isAfterLast()) {
                    if (getArguments().getString(Consts.CHECKCLICK_FROM).equalsIgnoreCase("search")) {
                        which_latlong = cursor.getString(cursor.getColumnIndex("search_whichlatlong"));
                    } else {
